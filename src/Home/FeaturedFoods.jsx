    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 mt-8">
      {sortbyQuantity.slice(0, 6).map((food) => (
        <motion.div
          ...
          key={food._id}
        >
          <div className=" px-0  rounded-lg border-2 ">
            <figure className=" relative font-anton">
              ...
              />
              <p className="absolute w-10 h-10 bg-[#1e847f] text-white top-2 rounded-full text-3xl right-3 flex items-center justify-center ">
                {food.quantity}
              </p>
            </figure>
