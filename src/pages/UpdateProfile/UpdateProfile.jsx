  ...
  <div className="hero-content mb-10  flex-col lg:flex-row-reverse">
    <div className="animate__animated animate__fadeInLeft  animate__delay-1s  text-center  lg:ml-32 lg:text-left border-2 px-5 md:px-10 lg:px-16 py-10 rounded-xl bg-opacity-60 bg-gray-500 ">
      ...
      <div className="  px-4 py-2 space-y-2">
        <h1 className="text-2xl font-semibold text-center text-white">{user?.displayName}</h1>
        <p className="pb-2 text-xl text-center font-bold  text-white">  لآ اِلَهَ اِلّا اللّهُ مُحَمَّدٌ رَسُوُل اللّهِ</p>
        {/* social icons  */}
        ...
        <div className=" flex items-center justify-center ">
            ...
            <Link to="/profile">
            <button  className="btn   bg-slate-100 border-[#23BE0A] hover:bg-[#23BE0A] transition  text-[#23BE0A]   duration-500  hover:text-white "><span className="px-2">Profile</span></button>
            </Link>
    ...
    <div className="animate__animated animate__fadeInRight animate__delay-1s   card shrink-0 w-full max-w-sm border-2 py-2 bg-opacity-60 bg-gray-500">
      <form onSubmit={handleSubmit}  className="card-body">
        <div className="form-control">
          ...
          <input defaultValue={user?.displayName} type="text" required name="name" placeholder="Enter your update Name" className="input input-bordered"  />
        </div>
        <div className="form-control">
          <label className="label">
            <span className="label-text text-white">Photo URL</span>
          </label>
          <input defaultValue={user?.photoURL} type="text" name="photo" required placeholder="Enter Your Photo URL" className="input input-bordered" />
        </div>
        <div className="form-control">
          <label className="label">
            <span className="label-text text-white">Photo URL</span>
          </label>
          <input value={user?.email} type="text" name="email"  className="input input-bordered" />
        </div>
        
        <div className="form-control mt-6">
        <button  className="w-full btn mt-2 text-sm font-bold bg-slate-100 border-[#23BE0A] hover:bg-[#23BE0A] transition  text-[#23BE0A]   duration-500  hover:text-white">Update</button>
        </div>
      </form>
    </div>
  </div>
