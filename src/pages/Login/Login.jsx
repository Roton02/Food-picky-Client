...
const Login = () => {
  ...
  return (
    ...
    <div className="flex flex-col max-w-md mx-auto   lg:my-5 p-6  sm:p-10  dark:text-white">
        ...
        <form onSubmit={handleSubmitLogin} className="space-y-12">
          ...
          <div className="space-y-2">
            <div>
              <button
                type="submit"
                className="w-full px-8 btn text-white font-anton hover:text-black bg-[#1e847f] py-3 font-semibold rounded-md dark:bg-violet-600 dark:text-gray-50"
              >
                Login
              </button>
            </div>
